...
export default function EnquiryPage() {
  ...
  const { register, watch } = useForm<FormValues>({
    defaultValues: { name: '', phone: '', city: '', shop: '', notes: '' },
  });
  ...
  const message = useMemo(
    () =>
      buildWhatsAppMessage({
        items,
        customerName: [values.name, values.shop].filter(Boolean).join(' · '),
  ...
  return (
    <section className="container-fluid py-10 lg:py-14">
      <div className="mb-8">
        ...
        <p className="mt-2 text-dark-600">
          Confirm your items and customer info, then send directly to our sales desk on WhatsApp.
        </p>
      </div>
        ...
        <div className="lg:col-span-7 space-y-3">
          ...
          <motion.ul layout className="space-y-3">
            {items.map((item) => (
              ...
              >
                <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-dark-50 to-dark-100 flex items-center justify-center font-bold text-xs text-dark-600 shrink-0">
                  {item.code.slice(0, 6)}
                </div>
              ...
              <div className="bg-[#25D366] text-white p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-white/80">
                    Sending to {siteConfig.whatsappDisplay}
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 space-y-2">
                ...
                {sent && (
                  <div className="flex items-center gap-2 text-sm text-primary font-semibold">
                    ...
                    Enquiry opened in WhatsApp — our team will reply shortly.
                  </div>
                )}
                <p className="text-xs text-dark-500 text-center">
                  Pricing & availability shared after verification.
                </p>
              </div>
            </div>
